...
predict_value2 = cross_val_score(pickled_model, farray, target_val, cv=5)
# print(predict_value2)
accuracy2 = predict_value2.mean()
# print(accuracy2)
test_predict_value = pickled_model.predict(fearray)
...
r_forest_predict2 = cross_val_score(random_forest_model, farray, target_val, cv=5)
# print(r_forest_predict2)
